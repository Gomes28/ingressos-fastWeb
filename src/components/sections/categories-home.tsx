    ...
    return (
        <section className='w-full max-w-8xl mx-auto'>
            ...
            <div className='grid grid-cols-8 gap-6'>
                {categories.map(item => (
                    <Link key={item.id} href={'/'} className='flex flex-col border bg-gray-50 text-gray-3 px-3 py-4 items-center rounded-2xl gap-1 hover:shadow-md hover:bg-primary-light hover:border-primary hover:text-primary transition-all'>
